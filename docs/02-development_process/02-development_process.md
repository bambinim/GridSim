...
La metodologia di sviluppo applicata su questo progetto è di tipo Agile, in particolare si è adottata una variante
di Scrum, cioè una metodologia di sviluppo Scrum-inspired.
...
Di seguito vengono elencati il *product backlog* e le documentazioni relative ai vari *sprint*:

- [Product Backlog](product_backlog.csv)
