...
Alla scadenza prevista, una parte dei work package pianificati non risultava ancora completata. Oltre agli impegni lavorativi e personali dei membri del gruppo che hanno ridotto la disponibilità temporale effettiva, ha inciso significativamente la complessità iniziale nel valutare e stimare l'effort effettivo richiesto da ciascun task del dominio, i cui requisiti di implementazione si sono rivelati in alcuni casi superiori alle aspettative. Le attività rimanenti sono state portate a termine successivamente.
...
È stato proprio durante questa prima esperienza che il gruppo ha riscontrato le difficoltà concrete nell'applicare stabilmente Scrum. Oltre alla variabilità della disponibilità individuale dovuta agli impegni lavorativi e personali dei membri, è emersa la complessità nel calibrare ed effettuare una stima realistica dell'effort dei task per un dominio a quel tempo ancora nuovo per il team. La combinazione di queste due criticità ha reso inefficace la rigidità di una pianificazione basata su intervalli temporali fissi e costanti, come dimostrato direttamente dai task rimasti incompleti alla scadenza dello sprint. Di conseguenza, risultava complesso organizzare il lavoro e i momenti di coordinamento secondo una cadenza regolare, nonostante l'utilità iniziale della metodologia per definire obiettivi e priorità condivisi.
