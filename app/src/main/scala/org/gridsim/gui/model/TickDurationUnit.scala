 ...
 *
 * Minutes/hours/days map to an exact [[FiniteDuration]]. Months and years
 * have no fixed length in reality (a month is 28-31 days), so they're
 * offered as documented approximations (30 and 365 days respectively) —
